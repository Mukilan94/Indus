...
{
    public partial class ConvCoreShows
    {
        public ConvCoreShows()
        {
        ...
        [InverseProperty(nameof(ConvCoreNatFlorPcs.ConvCoreShows))]
        public virtual ConvCoreNatFlorPcs NatFlorPc { get; set; }
        [ForeignKey(nameof(StainPcId))]
        [InverseProperty(nameof(ConvCoreStainPcs.ConvCoreShows))]
        public virtual ConvCoreStainPcs StainPc { get; set; }
