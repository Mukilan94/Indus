...
{
    internal class CustomErrorHandlerForRepository
    {
        ...
        public CustomErrorHandlerForRepository(RoleManager<IdentityRole> roleManager, UserManager<WellIdentityUser> userManager, WebAIAdvisorContext dbContext, Guid? userId)
        {
