...
function updatepackage(e) {
    ...
    var dispatchJson = JSON.stringify(UpdateSubscriptionViewModel);
    $.ajax({
        url: "/ProductSubscriptionSRVNew/UpdateDetails_Admin",
        type: "POST",
        dataType: "json",
        data: dispatchJson,
...
function newpayment() {
    ...
    window2.refresh({
        ...
        url: "/ProductSubscriptionSRVNew/ChangepaymentAD"
    });
