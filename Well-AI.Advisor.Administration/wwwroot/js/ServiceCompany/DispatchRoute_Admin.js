...
function Loadcurrentuserrout2(currentlocation) {
   // debugger;
    ...
    //debugger;
    //var destinationssimulationrequest = [];
    //if (dispatchlistarraymain[0].locationname != '') {

    //     destinationssimulationrequest = {
    //        origin: dispatchlistarraymain[0].locationname,
    //        priority: "travel_time",
    //        destinationsarray: destinations_array
    //    }
    //}
    ...
    //     destinationssimulationrequest = {
    //        origin:  {
    //            longitude: dispatchlistarraymain[0].latitude,
    //            latitude: dispatchlistarraymain[0].longitude,
    //        },
    //        priority: "travel_time",
    //        destinationsarray: destinations_array
    //    }
...
function LoadDispatchRouteUsers() {
    var window2 = $("#DispatchAssignUserWindow").data("kendoWindow");
    window2.refresh({
        ...
        if (truckstartplace == true) {
            ...
            new mapboxgl.Marker(el)
                ...
                .setPopup(
                    new mapboxgl.Popup({ offset: 25, closeButton: true, closeOnMove: true, className: 'pop-up' }) // add popups
                        .setHTML(
                            /* `<h3>${destinations[i].destination}</h3>`*/
                            `<div class="pop-head2" style="margin-top:5px"><label class="pop-head-font"
style="margin-top:15px">${destinations[i].destination}</label></div><div class="pop-bootom1" ">`
            ...
            var ETADatetime = (endDate).getMonth() + '/' + (endDate).getDay() + '/' + (endDate).getFullYear() + ' ' + (endDate).getHours() + ':' + (endDate).getMinutes();
                ...
                .setPopup(
                    new mapboxgl.Popup({ offset: 25, closeButton: true, closeOnMove: true, className: 'pop-up-op2' }) // add popups
                        .setHTML(
                            ...
                            //                            `<h4>${destinations[i].destination.place}</h4><p>${destinations[i].destination.place}</p>  <p>
                            //ETA :${ETADatetime}</p> <p>Total Duration :${total_duration_times}</p>
                            ...
                            .setPopup(
                                new mapboxgl.Popup({ offset: 25, closeButton: true, closeOnMove: true, className: 'pop-up-op'}) // add popups
                                    ...
                                    /*  `<h3>Current Location</h3><p>${arr[0]}</p><p>${arr[1]}</p>`*/
                                        ...
                                        `<div class="pop-head" style="margin-top:20px"><label class="pop-head-font"
style="margin-top:15px">${geojson[i].username}</label></div><div class="pop-bootom1" style="margin-top:25px;float:left">

<label>Longitude:${arr[0]}</label>  <br>
<label>Latitude : ${arr[1]}</label>  <br>
  <lbel>Address :${geojson[i].area}</label> <br>
<label>City     :${geojson[i].city}</label> <br>
   <label>State :${geojson[i].state}</label></div> <br>`
                                    )
                            )
                            .addTo(map);
                        if (i == 0) {
        ...
        .done(function () {
            ...
            if (subscriptionstatus === "Active") {
                if (dataItem.customer !== "") {
                    ...
                    //$.ajax({
                    //   // url: "/DispatchSRV/SendMailforOprator?userId='" + userid + "' & operatorId=" + operatorid  ,
                    //    url: "/DispatchSRV/ShareDriverLocationToOperator",
                    //    type: "POST",
                    //    dataType: "json",
