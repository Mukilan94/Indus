...
namespace Well_AI.Advisor.Log.Error
{
    public class CustomErrorHandler
    {
        ...
        public CustomErrorHandler(RoleManager<IdentityRole> roleManager, UserManager<WellIdentityUser> userManager, WebAIAdvisorContext dbContext, Guid? userId, Guid? companyId)
        {
