...
namespace WellAI.Advisor.Areas.ServiceCompany.Controllers
{
    [Area("ServiceCompany")]
    [SessionTimeOut]
    public class ServiceEditProfileController : BaseController
    {
        private readonly SignInManager<WellIdentityUser> _signInManager;
        private readonly ILogger<ServiceEditProfileController> _logger;
        private readonly RoleManager<IdentityRole> _roleManager;
        private readonly UserManager<WellIdentityUser> _userManager;
        private readonly WebAIAdvisorContext db;
        private readonly IConfiguration _configuration;
        private IMapper _mapper;
        public ServiceEditProfileController(SignInManager<WellIdentityUser> signInManager, UserManager<WellIdentityUser> userManager,
                                     RoleManager<IdentityRole> roleManager, WebAIAdvisorContext dbContext, ILogger<ServiceEditProfileController> logger,
        ...
        public async Task<ActionResult> Update()
        {
            try
            {
                ...
                return RedirectToAction("Index", "ServiceEditProfile");
            }
            catch (Exception ex)
            {
                CustomErrorHandler customErrorHandler = new CustomErrorHandler(_roleManager, _userManager, db, Guid.Parse(_userManager.GetUserId(User)), Guid.Parse(WellAIAppContext.Current.Session.GetString("TenantId")));
