...
namespace WellAI.Advisor.Areas.ServiceCompany.Models
{
    public class UserService : IUserService
    {
        ...
        public void Create(UserViewSRVModel user)
        {
        ...
        public List<UserViewSRVModel> GetAll()
        {
            var result = Session.GetObjectFromJson<List<UserViewSRVModel>>("Users");
        ...
        public IEnumerable<UserViewSRVModel> GetAllWithFilter(string userpart)
        {
            var result = Session.GetObjectFromJson<IList<UserViewSRVModel>>("Users");
        ...
        public IEnumerable<UserViewSRVModel> GetFirstLimit(int limit)
        {
            var result = Session.GetObjectFromJson<IList<UserViewSRVModel>>("Users");
        ...
        public IEnumerable<UserViewSRVModel> Read()
        {
            return GetAll();
        }

        public void Update(UserViewSRVModel user)
        {
            var users = GetAll();
            ...
            if (target != null)
            {
                ...
                if (user.BirthDate.HasValue)
                    target.BirthDate = user.BirthDate.Value;
