...
namespace WellAI.Advisor.Areas.OperatingCompany.Controllers
{
    ...
    public class ApiConfigurationController : BaseController
    {
        ...
        public ApiConfigurationController(UserManager<WellIdentityUser> userManager,
           SignInManager<WellIdentityUser> signInManager,
           RoleManager<IdentityRole> roleManager,
           WebAIAdvisorContext dbContext, ILogger<ApiConfigurationController> logger)
        ...
        private bool GetComponentsBasedOnRole()
        {
            ...
            if (roleResult != null)
            {
                ...
                return rolePermissionBusiness.GetComponentBasedOnRolesList(roleIds, "Configuration",TenantId);
            }
            else
            {
                return false;
