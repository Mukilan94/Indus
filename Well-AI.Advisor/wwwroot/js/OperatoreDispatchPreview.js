        ...
        success: function (response) {
          ...
          debugger;
            ...
            if (response.message == null || response.message == undefined || response.message == "") {
                ...
                $(".markerstart_preview_new").remove();
...
//                    .addTo(mappreview);
        ...
        el.className = 'truckcolor_preview';
   ...
   /// $(".k-grid-update").click(function () {
    ...
    $.ajax({
        url: '/Dispatch/GetActiveUserNotes?userId=' + userId,
        type: 'GET',
        dataType: "json",
        contentType: "application/json; chartset=uft-8",
...
function SaveDispatchUser() {
    if (dispatchlistarray.length == 0) {
        ...
        // debugger;
        $.ajax({
            url: "/Dispatch/AddNewDispatch_V2",
            type: "POST",
            dataType: "json",
            data: JSON.stringify(dispatchlistarray),
            contentType: "application/json; chartset=uft-8",
            success: function (response) {
                ...
                if (deleteddispatchlistarray.length > 0) {
                    $.ajax({
                        url: "/Dispatch/DeleteDispatch_V2?HistoryHeadId=" + response,
                        type: "POST",
                        dataType: "json",
                        data: JSON.stringify(deleteddispatchlistarray),
                        contentType: "application/json; chartset=uft-8",
