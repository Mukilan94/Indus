...
function updatepackage(e) {
    ...
    $.ajax({
        ...
        dataType: "json",
        url: "ProductSubscription/UpdateDetails",
...
function Cancelsubscription() {
    ...
    var result = kendo.confirm("Do you want to Cancel Subscription ?")
        .done(function () {
            ...
            var _SubscriptionId = "";
                        $.ajax({
                            url: "/ProductSubscription/CancelSubscription",
                        type: "POST",
                       // dataType: "json",
...
function newpayment() {
    ...
    var window2 = $("#addNewPaymentgirdop").data("kendoWindow");
    window2.refresh({
        //  url: "/ProductSubscriptionSRVNew/NewPayment"
        url: "/ProductSubscription/ChangepaymentmethodOP"
    });

    $("#addNewPaymentgirdop").closest(".k-window").css({
        top: 150,
        left: 650
    });
...
function newaddress() {
    ...
    window2.refresh({
        //  url: "/ProductSubscriptionSRVNew/NewPayment"
        url: "/ProductSubscription/Billinginfo"
    });
...
function addnewpayment() {
    ...
    window3.refresh({
        ...
        url: "../../ProductSubscription/addPayment"
    });
...
function closepayment() {
    var window = $("#addNewPaymentgirdop").data("kendoWindow");
    window.close();
}
