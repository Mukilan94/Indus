...
namespace Well_AI.Advisor.API.Controllers
{
    ...
    public class WellSubscriptionController : ControllerBase
    {
        private IWellSubscriptionRepository _subRepository;
        IHttpContextAccessor _httpContextAccessor;
        private readonly WebAIAdvisorContext _db;
        public WellSubscriptionController(IWellSubscriptionRepository subRepository,  IHttpContextAccessor httpContextAccessor, WebAIAdvisorContext db)
        {
